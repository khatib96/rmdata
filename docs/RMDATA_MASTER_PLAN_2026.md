...
- [ ] تحويل أكثر العمليات خطورة إلى REST endpoints.
  ...
  - [ ] الحذف النهائي للسجلات، إدارة المستخدمين، الضرائب والمدفوعات.
...
- [ ] تشديد `db/query` (قيد التنفيذ: الحارس والجرد والـ logging أنجزت؛ تم تحويل صلاحيات المستخدمين وأرشفة/استرجاع السجلات؛ باقي الحذف/المستخدمون/الضرائب).
