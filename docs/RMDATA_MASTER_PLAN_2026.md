...
- [x] تحويل أكثر العمليات خطورة إلى REST endpoints.
  ...
  - [x] الضرائب والمدفوعات عبر API/IPC صريح.
  - [x] تحديث حالة الموظف وسجل الحالة عبر API/IPC صريح.
  - [ ] إدارة المستخدمين وبقايا الإنشاء/التعديل الكبيرة.
...
- [x] تشديد `db/query` (Phase C مغلقة: الحارس والجرد والـ logging، صلاحيات المستخدمين، أرشفة/استرجاع/حذف الموارد الأساسية، الضرائب/المدفوعات، وتحديث حالة الموظف عبر API/IPC. البقايا الواسعة انتقلت للمرحلة D/G).
